...
import com.imranmelikov.qrcodescankotlin.databinding.FragmentScannerResultDialogBinding
...
class ScannerResultDialog(private val listener: DialogDismissListener) : BottomSheetDialogFragment() {
    ...
    private lateinit var binding:FragmentScannerResultDialogBinding
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentScannerResultDialogBinding.inflate(
